...
const CHAINS = {
  ...
  137:    { name: "Polygon",     short: "POL",   color: "#A855F7", explorer: "https://polygonscan.com/tx/",         rpc: "https://polygon-rpc.com" },
  43114:  { name: "Avalanche",   short: "AVAX",  color: "#EF4444", explorer: "https://snowtrace.io/tx/",            rpc: "https://api.avax.network/ext/bc/C/rpc" },
  56:     { name: "BNB Chain",   short: "BNB",   color: "#EAB308", explorer: "https://bscscan.com/tx/",             rpc: "https://bsc-dataseed.binance.org" },
  81457:  { name: "Blast",       short: "BLAST", color: "#D4D400", explorer: "https://blastscan.io/tx/",            rpc: "https://rpc.blast.io" },
  534352: { name: "Scroll",      short: "SCR",   color: "#E8AA6A", explorer: "https://scrollscan.com/tx/",          rpc: "https://rpc.scroll.io" },
  59144:  { name: "Linea",       short: "LNA",   color: "#61DFFF", explorer: "https://lineascan.build/tx/",         rpc: "https://rpc.linea.build" },
  5000:   { name: "Mantle",      short: "MNT",   color: "#00C3A0", explorer: "https://explorer.mantle.xyz/tx/",    rpc: "https://rpc.mantle.xyz" },
  ...
  2741:   { name: "Abstract",    short: "ABS",   color: "#C084FC", explorer: "https://abscan.org/tx/",              rpc: "https://api.mainnet.abs.xyz" },
  80094:  { name: "Berachain",   short: "BERA",  color: "#FB923C", explorer: "https://berascan.com/tx/",            rpc: "https://rpc.berachain.com" },
  999:    { name: "HyperEVM",    short: "HYPE",  color: "#34D399", explorer: "https://hyperevmscan.io/tx/",         rpc: "https://rpc.hyperliquid.xyz/evm" },
  57073:  { name: "Ink",         short: "INK",   color: "#F472B6", explorer: "https://inkscan.xyz/tx/",             rpc: "https://rpc-gel.inkonchain.com" },
  143:    { name: "Monad",       short: "MON",   color: "#818CF8", explorer: "https://monadexplorer.com/tx/",       rpc: "https://testnet-rpc.monad.xyz" },
  9745:   { name: "Plasma",      short: "PLS",   color: "#6EE7B7", explorer: "https://plasma.explorer/tx/",         rpc: "https://rpc.plasma.io" },
  // SVM
